...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const res = await axios.get(`/profile/info?memId=${context.query.memId}`, {
...
export default function Profile({ profileDataSSR }: { profileDataSSR: ProfileInfo }) {
  ...
  const [profileImg, setProfileImg] = useState<string>(
    profileDataSSR.MEM_IMG === "" ? "/images/photo_add.png" : `${process.env.NEXT_PUBLIC_SERVER_URL}/${profileDataSSR.MEM_IMG}`
  );
